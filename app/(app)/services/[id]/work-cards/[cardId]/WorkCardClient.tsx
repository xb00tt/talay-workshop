    ...
    <div className="p-6 lg:p-8 max-w-3xl mx-auto space-y-6">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl p-5">
        ...
        <div className="grid grid-cols-2 gap-3 text-sm mb-4">
          <div>
            <p className="text-xs text-gray-600 dark:text-gray-400 mb-0.5">{t('mechanic')}</p>
            <p className="text-gray-600 dark:text-gray-300">{wc.mechanicName ?? '—'}</p>
          </div>
          {wc.specialInstructions && (
            <div className="col-span-2">
              <p className="text-xs text-gray-600 dark:text-gray-400 mb-0.5">{t('specialInstructions')}</p>
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {!isTerminal && canCancelWorkCard && (
            <button
              ...
              className="px-3 py-1.5 text-xs rounded-lg border border-red-300 dark:border-red-800 text-red-700 dark:text-red-400 hover:text-red-900 dark:hover:text-red-300 hover:border-red-400 dark:hover:border-red-600 transition-colors disabled:opacity-40"
            >
              {t('cancel')}
            </button>
          )}
          {wc.status === 'CANCELLED' && canReopenWorkCard && (
            <button
              ...
              disabled={statusLoading}
              className="px-3 py-1.5 text-xs rounded-lg border border-blue-300 dark:border-blue-700 text-blue-700 dark:text-blue-400 hover:text-blue-900 dark:hover:text-blue-300 transition-colors disabled:opacity-40"
            >
              {t('reopen')}
            </button>
          )}
          {!isTerminal && canCompleteWorkCard && (
            <button
              ...
              disabled={statusLoading}
              className="px-3 py-1.5 text-xs rounded-lg border border-green-300 dark:border-green-800 text-green-700 dark:text-green-400 hover:text-green-900 dark:hover:text-green-300 transition-colors disabled:opacity-40"
            >
              {t('complete')}
            </button>
          )}
