...
export default function DriverFeedbackSection({
  service,
  onItemAdded,
  onItemUpdated,
  onItemDeleted,
  ...
  return (
    <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700/80 rounded-xl overflow-hidden">
      <div className="px-5 py-3 border-b border-gray-200 dark:border-gray-700/80">
        <span className="font-semibold text-sm text-gray-800 dark:text-white">{tService('driverFeedback')}</span>
      </div>
      <div className="px-5 py-3">
        <DriverFeedbackPanel
          serviceId={service.id}
          items={service.driverFeedbackItems}
          feedbackNotes={service.driverFeedbackNotes}
